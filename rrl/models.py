...
class RRL:
    def __init__(self, dim_list,  use_not=False, is_rank0=False, log_file=None, writer=None, left=None,
        ...
        self.net
        # if distributed:
        #     self.net = MyDistributedDataParallel(self.net,device_ids=[])
    ...
    def test(self, test_loader=None, set_name='Validation'):
        ...
        y_true = y_true.cpu().numpy().astype(np.int16)
